...
<body>
    ...
    <div class="container">
        ...
        <h2>자원봉사의 특성</h2>
        <ul>
            <li><strong>자발성:</strong> 자신의 의사로 시간과 재능, 경험을 도움이 필요한 이웃과 지역사회 공동체 형성에 아무런 대가 없이 활동하는 것</li>
            <li><strong>무보수성:</strong> 경제적 보상과 관련되는 것으로 자원봉사활동에 대해 금전적 대가를 받지 않는 것</li>
            <li><strong>공익성:</strong> 이웃과 지역사회 내에 산재하고 있는 문제를 해결하여 삶의 질을 향상시키기 위하여 활동하는 것</li>
            <li><strong>지속성:</strong> 자원봉사활동에 참여하게 되면 일정기간 동안 지속성과 정기적으로 봉사활동에 참여하는 것</li>
        </ul>
