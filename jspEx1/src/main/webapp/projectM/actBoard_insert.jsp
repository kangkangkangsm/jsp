...
<div class="container">
    ...
    <%@include file="db.jsp"%>	
        ...
        <div class="form-row3">
            <input type="date" id="start_date" name="start_date" value="2024-08-20">
            <span style="margin: 0 4px; margin-top:10px;">~</span>
            <input style="margin-left:8px" type="date" id="end_date" name="end_date" value="2024-12-31">    
            <input type="text" style="margin-left:30px;" id="mn_people" name="mn_people" placeholder="인원수" >        
        </div>
          <div class="form-row">
